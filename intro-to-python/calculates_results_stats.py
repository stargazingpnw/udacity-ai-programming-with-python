...
def calculates_results_stats(results_dic):
  ...
  # Process through the results dictionary
    ...
    # TODO: 5a. Count correctly classified dog breeds
    ...
    # TODO: 5b. Count correctly classified non-dog images
        else:
            if results_dic[key][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1

  # Calculates run statistics (counts & percentages) below using the counters
    results_stats_dic['n_images'] = len(results_dic)
    results_stats_dic['n_notdogs_img'] = results_stats_dic['n_images'] - results_stats_dic['n_dogs_img']

  # TODO: 5c. Calculate percentage of correctly matched images
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0

  # TODO: 5d. Calculate percentage of correctly classified dogs
  ...
  # TODO: 5e. Calculate percentage of correctly classified dog breeds
