...
def print_results(results_dic, results_stats_dic, model, 
  ...
  # TODO: 6a. Print number of Not-Dog Images
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))

  # Prints summary statistics (percentages) on Model Run
    print(" ")
    for key in results_stats_dic:
    # TODO: 6b. Print percentages starting with 'p'
        if key.startswith('p'):
  ...
  # Print incorrectly classified dogs (if requested)
    ...
    # TODO: 6c. Print misclassified dog labels
  ...
  # Print incorrectly classified breeds (if requested)
    ...
    # TODO: 6d. Print misclassified dog breeds
        for key in results_dic:
